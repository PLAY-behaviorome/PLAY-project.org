...
8. Ask parent if child spends time in each room: <say>Does [CHILD] spend any time in this room?</say> <say-es>¿[CHILD] pasa algo de tiempo en este cuarto?</say-es>
9. Ask parent about child’s objects in the room: <say>Do you keep anything for [CHILD] in this room? (If yes) Would you mind showing me?</say> <say-es>¿Guarda algo para [CHILD] en este cuarto? (If yes) ¿Me lo puede mostarar por favor?</say-es>

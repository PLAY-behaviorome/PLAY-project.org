...
Additionally, the mother must act as the caregiver during the one-hour natural interaction, which will be scheduled at a time when _only_ the mother and target child are present (i.e., no siblings or other caregivers are around).

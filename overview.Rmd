...
- be a single child (i.e., no siblings living in the home)
...
- be born to parents 21+ years of age (at the time of testing)

Additionally, the mother must act as the caregiver during the one-hour natural interaction, which will be scheduled at a time when _only_ the mother and child are present.
...
<img src="img/PLAY-collection-sites-_labeled_grey.png"/>

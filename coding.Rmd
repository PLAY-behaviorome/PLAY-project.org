...
* Each content area includes two passes: one pass for the infant and one pass for the mother. *For gesture alone, the baby and mom are coded together in a single pass.*

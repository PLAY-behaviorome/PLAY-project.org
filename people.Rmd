...
# Team
+:--------------------------------------+:--:+:--------------------------------------+:--:+:--------------------------------------+:--:+:--------------------------------------+
|![](img/people-kasey.png){width=150}   |    |![](img/people-orit.jpg){width=150}    |    |![](img/people-sarah.jpeg){width=150}  |    |![](img/people-lily.jpg){width=150}    |
+---------------------------------------+----+---------------------------------------+----+---------------------------------------+----+---------------------------------------+
|**Kasey Soska, Ph.D.**                 |    |**Orit Herzberg, D.P.T.**              |    |**Sarah Riley, M.A.**                  |    |**Lily Candelaria, B.S.**              |
+---------------------------------------+----+---------------------------------------+----+---------------------------------------+----+---------------------------------------+
|Science Director                       |    |Research Scientist                     |    |Project Coordinator                    |    |Research Staff                         |
+---------------------------------------+----+---------------------------------------+----+---------------------------------------+----+---------------------------------------+
|[email](mailto:kasey.soska@nyu.edu)    |    |[email](mailto:ohk2@nyu.edu)           |    |[email](mailto:sarah.riley@nyu.edu)    |    |[email](mailto:lhc336@nyu.edu)         |
+---------------------------------------+----+---------------------------------------+----+---------------------------------------+----+---------------------------------------+
...
+-------------------------+--------------------------------------------+---------------------+---------------------+
| Mike Frank              | Stanford University                        | Palo Alto, CA       | Coding              |
+-------------------------+--------------------------------------------+---------------------+---------------------+
...
+-------------------------+--------------------------------------------+---------------------+---------------------+
| Lana Karasik            | CUNY -- College of Staten Island           | Staten Island, NY   | Coding              |
+-------------------------+--------------------------------------------+---------------------+---------------------+
...
+-------------------------+--------------------------------------------+---------------------+---------------------+
| Jeff Lockman            | University of Texas at Austin              | Austin, TX          | Collecting & Coding |
+-------------------------+--------------------------------------------+---------------------+---------------------+
...
+-------------------------+--------------------------------------------+---------------------+---------------------+
| Lisa Oakes              | University of California at Davis          | Davis, CA           | Contributor         |
+-------------------------+--------------------------------------------+---------------------+---------------------+
